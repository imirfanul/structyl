...
import { Toast as ToastPrimitive } from '@your-lib/primitives';
...
const toastVariants = tv({
  base: [
    ...
    'data-[swipe=cancel]:translate-x-0 data-[swipe=end]:translate-x-[var(--your-lib-toast-swipe-end-x)] data-[swipe=move]:translate-x-[var(--your-lib-toast-swipe-move-x)] data-[swipe=move]:transition-none',
