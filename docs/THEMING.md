...
structyl uses a **CSS variables + Tailwind** approach for theming. This gives you:
...
<ThemeProvider
  ...
  storageKey="structyl-theme"   // localStorage key (false to disable)
...
```js
// tailwind.config.js
import yourLibPreset from '@structyl/styled/tailwind-preset';

export default {
  presets: [yourLibPreset],
  content: [
    './src/**/*.{ts,tsx}',
    './node_modules/@structyl/styled/dist/**/*.js',
  ],
};
```
